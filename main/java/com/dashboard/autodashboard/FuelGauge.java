...
public class FuelGauge extends Odometer {
 ...
 public void displayRemaingFuel() {
        System.out.println("Remaining fuel: " + getRemainingFuel(gallons) + " gallons.");
    }

    public int getRemainingFuel(int gallons) {
        gallons = getFuel(gallons) - MPG;
        return gallons;
    }
